...
Result folder: `artifacts/runs/2026-07-29T01-40-57Z-t11-dedupe-order-8n-8h`
...
- **Anomalies detected and resolved**: 779
- **Data loss**: 0 (zero leakage)
- **Pending work**: 0 (clean drain)

Detailed metrics: [standard-result.md](2026-07-29T01-40-57Z-t11-dedupe-order-8n-8h/standard-result.md)
